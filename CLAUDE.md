...
| --- | --- | --- | --- |
| `tutor-api` | Backend: nghiệp vụ, auth, thanh toán, mở khóa, lớp, sổ đầu bài, thông báo | NestJS 10 + PostgreSQL 15+ + Prisma | Đã có module đầy đủ; flow cURL 1-12 Verified, Flow 6/9 rerun 2026-07-19; 131 unit tests pass 2026-07-19 |
...
| `tutor-app` | App **gia sư**: hồ sơ, lịch dạy, dạy thử, sổ đầu bài, QR | Vite + React SPA | `TA-00`–`TA-06` DONE; current task `TA-07` |
...
| `tutor-e2e` | E2E smoke browser thật (Playwright) dùng chung cho 3 app; multi-project + seed dùng chung (`@kimthanh-tutor/e2e`) | Playwright + Chrome hệ thống | Harness + smoke TA-02/TA-03/TA-04/TA-05/TA-06, AD-00, TM-00 |

...
Trạng thái ngày 2026-07-16: `TA-00` DONE; 15 test, lint và production build đã pass theo evidence của task. `TA-01` (auth, role tutor và legal consent gate) là `Current task`; chưa xem placeholder của các task sau là feature đã hoàn tất.
